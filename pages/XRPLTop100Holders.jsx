...
function XRPLTop100Holders() {
  ...
  return (
    <div  className={classes.root} id="root">
          ...
          <title>XRPL Top 100 Holders</title>
        </Head>
       ...
       new Vue({
           ...
           methods: {
               getData: function() {
                   ...
                   axios.get('https://check.lucretius.network/bmp/holders100').then(res => {
                   this.obj = res.data
...
export default XRPLTop100Holders;